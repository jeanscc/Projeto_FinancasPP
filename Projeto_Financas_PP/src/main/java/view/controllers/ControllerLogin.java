...
public class ControllerLogin implements Initializable{
    ...
    void lsExit(MouseEvent event) {
    	((Button) event.getPickResult().getIntersectedNode()).setCursor(Cursor.DEFAULT);;
    }
	...
	public void initialize(URL location, ResourceBundle resources) {
		txEmail.setStyle("-fx-text-fill: lightgray; -fx-font-size: 12px;");
		txSenha.setStyle("-fx-text-fill: lightgray; -fx-font-size: 12px;");
